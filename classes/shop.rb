class Shop
    ...
    # array of shelves and candies that are not in any shelf
    def initialize
        @shelves = []
        @unshelved_candies = []
    end
    ...
    #deleting the shelf by making the candies in that shelf unshelved
    # adding the candies to array of unshelved candies
    # and changing the value of shelved variable in  each candy to false.
