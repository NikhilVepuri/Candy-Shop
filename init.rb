...
# User input will be stored in variable option
def select_option
...
def remove_shelf_with_input_validation
    puts "Enter the shelf number to remove:[e.x. 1]"
    print "> "
...
# Takes shelf number input for moving a candy and returns the shelf number
...
# Returns true if the input is equal any number in 1
